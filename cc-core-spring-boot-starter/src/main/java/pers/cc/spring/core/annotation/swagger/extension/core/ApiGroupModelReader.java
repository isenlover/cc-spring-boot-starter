...
import pers.cc.spring.core.annotation.swagger.extension.bean.BaseModel;
...
/**
 * 获取api pers.cc.cfootball.common.model 生成Model(包含swagger展示的相关字段,ModelRef引用的就是model)并缓存,增加关于组的Model放入缓存
 */
@Component
@Primary
...
public class ApiGroupModelReader extends ApiModelReader {
  ...
  @Autowired
  public ApiGroupModelReader(@Qualifier("cachedModels") ModelProvider modelProvider,
