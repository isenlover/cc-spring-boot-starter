...
public class WechatMenuImpl implements WechatMenuService {
    ...
    public Message<Menu> createNormalMenu(Menu menu) {
        String requestUrl = WechatUtil.getRealUrlReplaceAccessToken(WechatMenuUrl.createNormalUrl.getUrl());
    ...
    public Message<ConditionalMenu> createConditionalMenu(ConditionalMenu menu) {
        String requestUrl = WechatUtil.getRealUrlReplaceAccessToken(WechatMenuUrl.createConditionalUrl.getUrl());
    ...
    public Message<MenuMessage> getAllMenu() {
        String requestUrl = WechatUtil.getRealUrlReplaceAccessToken(WechatMenuUrl.getAllUrl.getUrl());
        return WechatUtil.httpsGetWechat(requestUrl, MenuMessage.class);
    }

    public Message<WxBaseResponse> deleteAllMenu() {
        String requestUrl = WechatUtil.getRealUrlReplaceAccessToken(WechatMenuUrl.deleteAllUrl.getUrl());
    ...
    public Message<WxBaseResponse> deleteConditionalMenu(String menuID) {
        String requestUrl = WechatUtil.getRealUrlReplaceAccessToken(WechatMenuUrl.deleteConditionalUrl.getUrl());
    ...
    public Message<MenuMessage> getUserMenus(String openID) {
        String requestUrl = WechatUtil.getRealUrlReplaceAccessToken(WechatMenuUrl.getUserMenusUrl.getUrl());
